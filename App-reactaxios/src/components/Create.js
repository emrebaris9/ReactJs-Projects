...
export default class Create extends Component {
    ...
    onChangeHostName(e) {
        this.setState({
            name: e.target.value     // Girilen verileri al
        });
    }
    onChangePort(e) {
        this.setState({
    ...
    }  // şimdi girilen veriler gönderildi ve ardından temizlendi
        ...
        return (
            <div style={{marginTop: 50}}>
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        <input type="submit" value="Clear All" className="btn btn-primary"/>
                    </div>
                </form>
            </div>
        )
